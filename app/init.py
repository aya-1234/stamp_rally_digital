...
def initialize_db(app):
    ...
    with app.app_context():
        ...
        if db.session.query(Checkpoint).count() == 0:
            ...
            test_quizzes = [
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=1.0, content="テスト問題1", correct="1", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3"),
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=2.0, content="テスト問題2", correct="2", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3"),
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=3.0, content="テスト問題3", correct="3", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3"),
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=1.0, content="テスト問題1", correct="1", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3"),
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=2.0, content="テスト問題2", correct="2", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3"),
                Quiz(checkpoint_id=test_checkpoints[1].id, quiz_order=3.0, content="テスト問題3", correct="3", answer_1="選択肢1", answer_2="選択肢2", answer_3="選択肢3")
            ]
